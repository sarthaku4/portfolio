...
export function GridVignetteBackground({
  ...
  return (
    <div
      className={cn(
        "fixed inset-0 z-[-1] opacity-50 bg-[image:linear-gradient(to_right,hsl(var(--muted-foreground)),transparent_1px),linear-gradient(to_bottom,hsl(var(--muted-foreground)),transparent_1px)]",
        className
      )}
      style={{
